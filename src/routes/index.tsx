      ...
      <section className="relative overflow-hidden border-b">
        ...
        <div className="mx-auto grid min-h-[auto] min-w-0 max-w-[1440px] items-center gap-8 px-4 pt-6 pb-10 sm:px-5 sm:pt-10 sm:pb-16 lg:grid-cols-[minmax(0,0.94fr)_minmax(0,1.06fr)] lg:min-h-[680px] lg:gap-12 lg:px-10 lg:pt-12 xl:px-16">
          ...
          <div className="relative mx-auto w-full max-w-[240px] pb-6 sm:max-w-lg sm:pb-10 lg:max-w-xl lg:translate-x-0">
            ...
            <div className="bg-sidebar shadow-brand absolute right-5 bottom-0 w-[15%] rotate-3 rounded-[18px] border-[5px] border-sidebar p-1 sm:right-3 sm:w-[22%] sm:rounded-[24px] sm:border-[9px]">
